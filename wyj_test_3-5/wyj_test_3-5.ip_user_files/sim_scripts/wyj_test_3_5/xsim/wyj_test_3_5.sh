...
#
# Script generated by Vivado on Sun Apr 27 12:25:51 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : wyj_test_3_5.sh
...
#
# Usage        : wyj_test_3_5.sh
#                wyj_test_3_5.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                wyj_test_3_5.sh [-reset_run]
#                wyj_test_3_5.sh [-reset_log]
#                wyj_test_3_5.sh [-help]
#
...
# script info
echo -e "wyj_test_3_5.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./wyj_test_3_5.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot wyj_test_3_5 xil_defaultlib.wyj_test_3_5 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim wyj_test_3_5 -key {Behavioral:sim_1:Functional:wyj_test_3_5} -tclbatch cmd.tcl -protoinst "protoinst_files/wyj_test_3_5.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb wyj_test_3_5.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./wyj_test_3_5.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: wyj_test_3_5.sh [-help]\n\
Usage: wyj_test_3_5.sh [-step]\n\
Usage: wyj_test_3_5.sh [-lib_map_path]\n\
Usage: wyj_test_3_5.sh [-reset_run]\n\
Usage: wyj_test_3_5.sh [-reset_log]\n\
Usage: wyj_test_3_5.sh [-keep_index]\n\
Usage: wyj_test_3_5.sh [-noclean_files]\n\n\
